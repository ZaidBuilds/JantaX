...
export const MOCK_INFRA_PROJECTS: InfraProject[] = [
  {
    ...
    contractorDetails: {
      id: 'cont-sample-a',
      name: 'M/s Sample Contractor A Infrastructure',
      registrationNumber: 'DL-PWD-CAT1-2018-092',
      jvPartners: ['Sample Contractor C Infrastructure Ltd'],
    ...
    workOrders: [
      {
        ...
        awardedContractor: 'M/s Sample Contractor A Infrastructure',
    ...
    history: [
      ...
      },
      {
        id: 'hist-del-02',
        date: '2022-02-18',
        title: 'Work Order Awarded to Sample Contractor A',
  ...
  },
  {
    ...
    contractorDetails: {
      id: 'cont-sample-bc',
      name: 'Sample Contractor B - Sample Contractor C JV',
      registrationNumber: 'KA-BMRCL-JV-2020-009',
      jvPartners: ['Sample Contractor B Limited', 'Sample Contractor C Infrastructure'],
    ...
    workOrders: [
      {
        ...
        awardedContractor: 'Sample Contractor B - Sample Contractor C JV',
    ...
    history: [
      ...
      },
      {
        id: 'hist-blr-02',
        date: '2021-05-10',
        title: 'Contract Awarded to Sample Contractor B-C JV',
  ...
  },
  {
    ...
    contractorDetails: {
      id: 'cont-lt-coastal',
      name: 'M/s Sample Contractor A Heavy Civil',
    ...
    workOrders: [
      {
        ...
        awardedContractor: 'M/s Sample Contractor A Heavy Civil',
    ...
    history: [
      ...
      },
      {
        id: 'hist-mum-02',
        date: '2018-10-01',
        title: 'Work Order Awarded to Sample Contractor A Heavy Civil',
        titleHindi: 'कार्य आदेश जारी',
        eventType: 'Work Order',
  ...
  },
  {
    ...
    contractorDetails: {
      id: 'cont-sample-d',
      name: 'M/s Sample Water Works D Limited',
    ...
    workOrders: [
      {
        ...
        awardedContractor: 'M/s Sample Water Works D Limited',
    ...
    history: [
      ...
      },
      {
        id: 'hist-vns-02',
        date: '2021-03-12',
        title: 'Work Order Awarded to Sample Water Works D',
