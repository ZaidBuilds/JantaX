...
export const MOCK_PUBLIC_AUTHORITIES: PublicAuthority[] = [
  {
    ...
    faa: {
      name: 'First appellate authority (sample 1)',
      nameHi: 'प्रथम अपीलीय अधिकारी (नमूना 1)',
  ...
  },
  {
    ...
    faa: {
      name: 'First appellate authority (sample 2)',
      nameHi: 'प्रथम अपीलीय अधिकारी (नमूना 2)',
  ...
  },
  {
    ...
    faa: {
      name: 'First appellate authority (sample 3)',
      nameHi: 'प्रथम अपीलीय अधिकारी (नमूना 3)',
  ...
  },
  {
    ...
    faa: {
      name: 'First appellate authority (sample 4)',
      nameHi: 'प्रथम अपीलीय अधिकारी (नमूना 4)',
