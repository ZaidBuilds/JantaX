...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  const filteredProjects = useMemo(() => {
    return projects.filter(p => {
      ...
      return matchesSearch && matchesSector && matchesStatus && matchesState && matchesYear;
    });
  }, [projects, searchQuery, selectedSector, selectedStatus, selectedState, selectedYear]);
    ...
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ 
        ...
        <div className="glass-card" style={{ padding: '1rem', borderLeft: '4px solid var(--color-primary)' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, marginTop: '0.25rem', color: '#ffffff' }}>₹{metrics.totalBudget} Cr</h2>
      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div className="glass-card" style={{ padding: '1.25rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <h3 style={{ fontSize: '1.1rem', color: '#ffffff' }}>Filter Operations</h3>
            <div style={{ 
              display: 'grid', 
